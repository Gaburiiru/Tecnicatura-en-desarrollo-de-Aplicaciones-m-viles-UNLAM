...
public class TestCases {
	...
	@Test
	public void queSePuedaCrearUnaBatalla() throws BatallaInexistente {
		FuerzaArmada argentina = new FuerzaArmada();
	...
	public void queSeNoSePuedaEnviarAUnaBatallaEnTierraUnBarco() throws VehiculoInexistente, VehiculoIncompatible, BatallaInexistente {
		FuerzaArmada argentina = new FuerzaArmada();
	...
	@Test (expected = BatallaInexistente.class)
	public void queSeNoSePuedaEnviarUnVehiculoAUnaBatallaQueNoExista() throws VehiculoInexistente, VehiculoIncompatible, BatallaInexistente {
		FuerzaArmada argentina = new FuerzaArmada();
		...
		assertFalse(argentina.enviarALaBatalla("San Martin", 5));
	}
	
	@Test 
	public void queSePuedaCambiarLaVelocidadDeUnTanque() {
		Terrestre tanque = new Tanque(5, "Renault FT");
		tanque.setVelocidad(25.0);
		assertEquals(25.0, tanque.getVelocidad(), 0.1);		
	}
